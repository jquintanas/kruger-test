...
(
    ...
    CONSTRAINT fk7tetln4r9qig7tp05lsdqe8xo FOREIGN KEY (owner_id)
...
(
    ...
    CONSTRAINT fk3cjmgekj641ph0muq32huj8ux FOREIGN KEY (assigned_to_id)
        REFERENCES public.users (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
...
INSERT INTO public.users (
    ...
    'ADM',
    'test@email.com',
    '$2a$10$nf0484jKPX4UfT7DBtwJZeHMovqmN/STg9SBuYCU57P2H11EVM/iW',
    'ADMIN',
    '',
    'test'
);
